...
import tests.event.planner.pages.event.EditActivityPage;
...
public class EditActivityTest {
    ...
    public void setup() {
        ...
        driver.get("http://localhost:4200/home/agenda/edit/1");
        editActivityPage = new EditActivityPage(driver);
    }
    ...
    public void testSetTitle() {
        Assertions.assertTrue(editActivityPage.isPageLoaded(), "Edit Activity page did not load.");
        ...
        Helper.takeScreenshoot(driver, "edit_activity_set_title");
    }
    ...
    public void testSetDescription() {
        ...
        Helper.takeScreenshoot(driver, "edit_activity_set_description");
    }


    @Test
    public void testSubmitActivityEditForm() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        ...
        Assertions.assertEquals("Edit Activity", pageTitle.getText(), "Page did not load correctly.");

        // Fill out the form fields
        WebElement titleInput = driver.findElement(By.cssSelector("input[formcontrolname='title']"));
        titleInput.clear();
        titleInput.sendKeys("Test Activity123");
        ...
        WebElement createButton = driver.findElement(By.xpath("//p-button//button[normalize-space()='EDIT ACTIVITY']"));

// Click the "Create Event" button
        createButton.click();

        // Wait for navigation to the "home/agenda" page
        wait.until(ExpectedConditions.urlContains("home"));

// Assert that the URL is correct
        String currentUrl = driver.getCurrentUrl();
        Assertions.assertTrue(currentUrl.contains("home"), "The user was not redirected to the 'home' page.");

        Helper.takeScreenshoot(driver, "edit_activity_submit");
    }
    ...
    public void testSetStart() {
        ...
        Helper.takeScreenshoot(driver, "edit_activity_set_start");
    }
    ...
    public void testSetEnd() {
        ...
        Helper.takeScreenshoot(driver, "edit_activity_set_end");
    }
    ...
    public void testSetAddress() {
        ...
        Helper.takeScreenshoot(driver, "edit_activity_set_address");
    }
